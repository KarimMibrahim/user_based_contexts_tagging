...
EXPERIMENTNAME = "multi_label_user"
...
#POS_WEIGHTS = [9.0 for x in range(len(LABELS_LIST))]
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            for batch_counter in range(TRAINING_STEPS):
                ...
                batch_loss[batch_counter], batch_accuracy[batch_counter], _ = sess.run(
            ...
            for validation_batch in range(VALIDATION_STEPS):
                ...
                val_losses[validation_batch], val_accuracies[validation_batch], = sess.run(
                    [loss, accuracy],
                    feed_dict={
                        x_input: val_batch[0],
